    ...
    <>
      {type === 0 && (
        <div className='py-4 px-4 text-zinc-100 bg-zinc-900 rounded mx-4 my-4 w-96 border border-zinc-500/40 hover:border-blue-700/40 hover:bg-blue-900/10'>
          <p className='text-xs text-blue-500'>Matematica</p>
          <p>{name}</p>
        </div>
      )}
      {type === 1 && (
        ...
        <p className='text-xs text-red-500'>Português</p>
        <p>{name}</p>
      </div>
      )}
      {type === 2 && (
        ...
        <p className='text-xs text-green-500'>Algebra</p>
        <p>{name}</p>
      </div>
      )}
      {type === 3 && (
        ...
        <p className='text-xs text-yellow-500'>Algebra</p>
        <p>{name}</p>
      </div>
      )}
    </>
